...
async def get_odata_items(
    ...
    select_fields: str | None = Query(None, alias="$select", description="OData select expression"),
    orderby: str | None = Query(None, alias="$orderby", description="OData orderby expression"),
    ...
    response = {"odata.context": "https://api.zguba.gov/odata/$metadata", "value": items_data}
            ...
            "edmx:DataServices": {
                ...
                "Schema": {
                    ...
                    "EntityContainer": {
                        ...
                        "EntitySet": {"@Name": "FoundItems", "@EntityType": "Zguba.Models.FoundItem"},
                    },
                },
            },
        }
